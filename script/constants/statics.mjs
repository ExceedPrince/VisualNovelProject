export const GAME_DATA_1 = 'gameData_1';
export const GAME_DATA_2 = 'gameData_2';

export const BACK_TO_MENU_OPEN = 'BACK_TO_MENU_OPEN_OPEN';
...
export const QUIT_OPEN = 'QUIT_OPEN';
