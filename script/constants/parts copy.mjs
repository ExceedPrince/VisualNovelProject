	...
	},
	{
		...
		story: {
			...
			"4": {
				...
				background: ["backgrounds/BG_clothing_store", "backgrounds/testBG_2"],
				charContainer: ['char-left', null, 'char-right'],
				image: ['Tomoka_normal', null, ['Kagano_smile', 'Kagano_sad']],
				choicePath: 'reina~importants~0003-3', //reina%lindsay
				class: [null, null, 'fadeRight'],
			  	name: "Kagano",
			  	text: [
			...
			"8": {
				...
				specialSceneId: ["harem_ending_1", "test-0003-8"],
				background: ["special_scenes/harem_ending_1", "special_scenes/test-0003-8"],
				charContainer: ['char-left', null, 'char-right'],
	...
	{ sceneId: "0009" }, //mobileScene: 0009
	{
		...
		story: {
			"1": {
				...
				charContainer: [null, "char-middle", null],
				image: [null, "Tomoka_normal", null],
				class: [null, "fadeUp", null],
			  	name: "Tomoka",
			  	text: "This is a test scene before Lindsay ending. Let's see...",
				choiceNext: false,
				endingNext: 'lindsay'
			}
		},
